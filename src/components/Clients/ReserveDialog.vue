  ...
  >
    <div class="w-6/12 bg-white flex flex-col rounded">
      <div class="flex justify-center items-center px-6 py-4 border-b">
        <span class="font-medium text-gray-600 text-xl flex-grow"
          >Записать на просмотр квартиры</span
        >
        <button
          class="
            focus:outline-none
      ...
      <div class="flex-grow py-4 px-6">
        ...
        <h3 class="font-medium text-gray-500 mb-2 mt-4">
          Агент, который поедет показывать квартиру
        </h3>
        <div
          class="
            flex-grow
        ...
        >
          ...
          <div
            v-if="openList"
            class="absolute top-full h-20 w-full right-0 pt-2 z-50"
            v-click-outside="
              () => {
                openList = false;
              }
